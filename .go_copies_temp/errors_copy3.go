...
var (
	...
	ErrSchemaIsEnabled                 = sdkerrors.Register(ModuleName, 220, "This schema is already enable")
	ErrLockedAssetNotFound             = sdkerrors.Register(ModuleName, 221, "Locked asset not found")
	// Action (300-399)
