...
func request_Query_ListActiveProposal_0(ctx context.Context, marshaler runtime.Marshaler, client QueryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq QueryListActiveProposalRequest
	var metadata runtime.ServerMetadata
...
func request_Query_LockSchemaFee_0(ctx context.Context, marshaler runtime.Marshaler, client QueryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq QueryGetLockSchemaFeeRequest
	var metadata runtime.ServerMetadata
...
func request_Query_LockSchemaFeeAll_0(ctx context.Context, marshaler runtime.Marshaler, client QueryClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	...
	if err := runtime.PopulateQueryParameters(&protoReq, req.Form, filter_Query_LockSchemaFeeAll_0); err != nil {
		return nil, metadata, status.Errorf(codes.InvalidArgument, "%v", err)
	}
...
func RegisterQueryHandlerServer(ctx context.Context, mux *runtime.ServeMux, server QueryServer) error {
	...
	mux.Handle("GET", pattern_Query_ListActiveProposal_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_Query_ListActiveProposal_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
	...
	mux.Handle("GET", pattern_Query_LockSchemaFee_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_Query_LockSchemaFee_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
	...
	mux.Handle("GET", pattern_Query_LockSchemaFeeAll_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := local_request_Query_LockSchemaFeeAll_0(rctx, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
...
func RegisterQueryHandlerClient(ctx context.Context, mux *runtime.ServeMux, client QueryClient) error {
	...
	mux.Handle("GET", pattern_Query_ListActiveProposal_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Query_ListActiveProposal_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_Query_LockSchemaFee_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Query_LockSchemaFee_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
	...
	mux.Handle("GET", pattern_Query_LockSchemaFeeAll_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_Query_LockSchemaFeeAll_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"thesixnetwork", "sixnft", "nftmngr", "params"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_NFTSchema_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"thesixnetwork", "sixnft", "nftmngr", "nft_schema", "code"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_NFTSchemaAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"thesixnetwork", "sixnft", "nftmngr", "nft_schema"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_NftData_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"thesixnetwork", "sixnft", "nftmngr", "nft_data", "nftSchemaCode", "tokenId"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_NftDataAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"thesixnetwork", "sixnft", "nftmngr", "nft_data"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ActionByRefId_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"thesixnetwork", "sixnft", "nftmngr", "action_by_ref_id", "refId"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ActionByRefIdAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"thesixnetwork", "sixnft", "nftmngr", "action_by_ref_id"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_Organization_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"thesixnetwork", "sixnft", "nftmngr", "organization", "name"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_OrganizationAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"thesixnetwork", "sixnft", "nftmngr", "organization"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_NftCollection_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"thesixnetwork", "sixnft", "nftmngr", "nft_collection", "nftSchemaCode"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_NFTSchemaByContract_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"thesixnetwork", "sixnft", "nftmngr", "nft_schema_by_contract", "originContractAddress"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_NFTSchemaByContractAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"thesixnetwork", "sixnft", "nftmngr", "nft_schema_by_contract"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_NFTFeeConfig_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"thesixnetwork", "sixnft", "nftmngr", "nft_fee_config"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_NFTFeeBalance_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"thesixnetwork", "sixnft", "nftmngr", "nft_fee_balance"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_MetadataCreator_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"thesixnetwork", "sixnft", "nftmngr", "metadata_creator", "nftSchemaCode"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_MetadataCreatorAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"thesixnetwork", "sixnft", "nftmngr", "metadata_creator"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ActionExecutor_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"thesixnetwork", "sixnft", "nftmngr", "action_executor", "nftSchemaCode", "executorAddress"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ActionExecutorAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"thesixnetwork", "sixnft", "nftmngr", "action_executor"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SchemaAttribute_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"thesixnetwork", "sixnft", "nftmngr", "schema_attribute", "nftSchemaCode", "name"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_SchemaAttributeAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"thesixnetwork", "sixnft", "nftmngr", "schema_attribute"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ListAttributeBySchema_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"thesixnetwork", "sixnft", "nftmngr", "list_attribute_by_schema", "nftSchemaCode"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ActionOfSchema_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4, 1, 0, 4, 1, 5, 5}, []string{"thesixnetwork", "sixnft", "nftmngr", "action_of_schema", "nftSchemaCode", "name"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ActionOfSchemaAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"thesixnetwork", "sixnft", "nftmngr", "action_of_schema"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ExecutorOfSchema_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"thesixnetwork", "sixnft", "nftmngr", "executor_of_schema", "nftSchemaCode"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ExecutorOfSchemaAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"thesixnetwork", "sixnft", "nftmngr", "executor_of_schema"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_VirtualAction_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"thesixnetwork", "sixnft", "nftmngr", "virtual_action", "nftSchemaCode"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_VirtualActionAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"thesixnetwork", "sixnft", "nftmngr", "virtual_action"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_VirtualSchema_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"thesixnetwork", "sixnft", "nftmngr", "virtual_schema", "nftSchemaCode"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_VirtualSchemaAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"thesixnetwork", "sixnft", "nftmngr", "virtual_schema"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_VirtualSchemaProposal_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"thesixnetwork", "sixnft", "nftmngr", "virtual_schema_proposal", "index"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_VirtualSchemaProposalAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"thesixnetwork", "sixnft", "nftmngr", "virtual_schema_proposal"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_ListActiveProposal_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"thesixnetwork", "six-protocol", "nftmngr", "list_active_proposal"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_LockSchemaFee_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"thesixnetwork", "six-protocol", "nftmngr", "lock_schema_fee", "index"}, "", runtime.AssumeColonVerbOpt(false)))

	pattern_Query_LockSchemaFeeAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"thesixnetwork", "six-protocol", "nftmngr", "lock_schema_fee"}, "", runtime.AssumeColonVerbOpt(false)))
)
...
var (
	...
	forward_Query_ListActiveProposal_0 = runtime.ForwardResponseMessage

	forward_Query_LockSchemaFee_0 = runtime.ForwardResponseMessage

	forward_Query_LockSchemaFeeAll_0 = runtime.ForwardResponseMessage
)
