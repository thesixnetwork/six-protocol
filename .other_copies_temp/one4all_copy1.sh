...
for i in "${!action_list[@]}"; do
    ...
    #read -p "Press enter to continue"
    if sixd tx nftmngr perform-action-by-nftadmin dee_dev01.multiaction 1 $action dee_dev01.multiaction_TK1_${action} $params --from ${key} --gas auto --gas-adjustment 1.5 --gas-prices 1.25usix -y \
        --node ${RPC_ENDPOINT} --chain-id ${CHAIN_ID} | grep -q 'msg_index: 0'; then
        echo "✅ $action"
        TOTAL=$((TOTAL+1))
        PASSED=$((PASSED+1))
...
# echo "Test Hide Fail"
#read -p "Press enter to continue"
if sixd tx nftmngr perform-action-by-nftadmin dee_dev01.multiaction 1 test_hidden hidden_fail "[{\"name\":\"attribute_name\",\"value\":\"hide_fail\"},{\"name\":\"show\",\"value\":\"false\"}]" \
...
#read -p "Press enter to continue"
if sixd tx nftmngr perform-multi-token-action dee_dev01.multiaction 10 start_mission oneonezero "[[]]" --from ${key} \
...
# echo "Test Multi Action(one token one action) - Case param required > 0"
#read -p "Press enter to continue"
if sixd tx nftmngr perform-multi-token-action dee_dev01.multiaction 10 transfer oneonenonzero "[[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}]]" --from ${key} \
    --gas auto --gas-adjustment 1.5 --gas-prices 1.25usix -y --node ${RPC_ENDPOINT} --chain-id ${CHAIN_ID} | grep -q 'msg_index: 0'; then
    echo "✅ Test Multi Action(one token one action) - Case param required > 0"
    TOTAL=$((TOTAL+1))
    PASSED=$((PASSED+1))
...
#read -p "Press enter to continue"
if sixd tx nftmngr perform-multi-token-action dee_dev01.multiaction 3,4,5 start_mission manyonezero "[[]]" --from ${key} \
    --gas auto --gas-adjustment 1.5 --gas-prices 1.25usix -y --node ${RPC_ENDPOINT} --chain-id ${CHAIN_ID} | grep -q 'msg_index: 0'; then
    echo "✅ Test Multi Action(multi token one action) - Case param required = 0"
    TOTAL=$((TOTAL+1))
    PASSED=$((PASSED+1))
...
# echo "Test Multi Action(multi token one action) - Case param required > 0"
#read -p "Press enter to continue"
if sixd tx nftmngr perform-multi-token-action dee_dev01.multiaction 3,4,5 transfer manyonenonzero "[[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}]]" --from ${key} \
    --gas auto --gas-adjustment 1.5 --gas-prices 1.25usix -y --node ${RPC_ENDPOINT} --chain-id ${CHAIN_ID} | grep -q 'msg_index: 0'; then
    echo "✅ Test Multi Action(multi token one action) - Case param required > 0"
    TOTAL=$((TOTAL+1))
    PASSED=$((PASSED+1))
...
#read -p "Press enter to continue"
if sixd tx nftmngr perform-multi-token-action dee_dev01.multiaction 11 start_mission,test_read_nft,test_hidden onemanyfail "[[],[],[],[],[],[{\"name\":\"attribute_name\",\"value\":\"hide_pass\"},{\"name\":\"show\",\"value\":\"true\"}]]" --from ${key} \
...
#read -p "Press enter to continue"
if sixd tx nftmngr perform-multi-token-action dee_dev01.multiaction 11 start_mission,test_read_nft,test_split,test_lowercase,test_uppercase,test_hidden onemanypass "[[],[],[],[],[],[{\"name\":\"attribute_name\",\"value\":\"hide_pass\"},{\"name\":\"show\",\"value\":\"true\"}]]" --from ${key} \
    --gas auto --gas-adjustment 1.5 --gas-prices 1.25usix -y --node ${RPC_ENDPOINT} --chain-id ${CHAIN_ID} | grep -q 'msg_index: 0'; then
    echo "✅ Test Multi Action(one token multi action) - Case Pass"
    TOTAL=$((TOTAL+1))
    PASSED=$((PASSED+1))
...
#read -p "Press enter to continue"
if sixd tx nftmngr perform-multi-token-action dee_dev01.multiaction 11 transfer,transfer onemany202 "[[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}]]" --from ${key} \
    --gas auto --gas-adjustment 1.5 --gas-prices 1.25usix -y --node ${RPC_ENDPOINT} --chain-id ${CHAIN_ID} | grep -q 'msg_index: 0'; then
    echo "✅ Test Multi Action(one token multi action) - Case 202"
    TOTAL=$((TOTAL+1))
    PASSED=$((PASSED+1))
...
#read -p "Press enter to continue"
if sixd tx nftmngr perform-multi-token-action dee_dev01.multiaction 12 start_mission,transfer onemany211 "[[],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}]]" --from ${key} \
    --gas auto --gas-adjustment 1.5 --gas-prices 1.25usix -y --node ${RPC_ENDPOINT} --chain-id ${CHAIN_ID} | grep -q 'msg_index: 0'; then
    echo "✅ Test Multi Action(one token multi action) - Case 211"
    TOTAL=$((TOTAL+1))
    PASSED=$((PASSED+1))
...
#read -p "Press enter to continue"
if sixd tx nftmngr perform-multi-token-action dee_dev01.multiaction 13 start_mission,test_read_nft onemany220 "[[],[]]" --from ${key} \
    --gas auto --gas-adjustment 1.5 --gas-prices 1.25usix -y --node ${RPC_ENDPOINT} --chain-id ${CHAIN_ID} | grep -q 'msg_index: 0'; then
    echo "✅ Test Multi Action(one token multi action) - Case 220"
    TOTAL=$((TOTAL+1))
    PASSED=$((PASSED+1))
...
#read -p "Press enter to continue"
if sixd tx nftmngr perform-multi-token-action dee_dev01.multiaction 13 transfer,transfer,transfer onemany303 "[[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}]]" --from ${key} \
    --gas auto --gas-adjustment 1.5 --gas-prices 1.25usix -y --node ${RPC_ENDPOINT} --chain-id ${CHAIN_ID} | grep -q 'msg_index: 0'; then
    echo "✅ Test Multi Action(one token multi action) - Case 303"
    TOTAL=$((TOTAL+1))
    PASSED=$((PASSED+1))
...
#read -p "Press enter to continue"
if sixd tx nftmngr perform-multi-token-action dee_dev01.multiaction 14 start_mission,transfer,transfer onemany312 "[[],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}]]" --from ${key} \
    --gas auto --gas-adjustment 1.5 --gas-prices 1.25usix -y --node ${RPC_ENDPOINT} --chain-id ${CHAIN_ID} | grep -q 'msg_index: 0'; then
    echo "✅ Test Multi Action(one token multi action) - Case 312"
    TOTAL=$((TOTAL+1))
    PASSED=$((PASSED+1))
...
#read -p "Press enter to continue"
if sixd tx nftmngr perform-multi-token-action dee_dev01.multiaction 15 start_mission,test_read_nft,transfer onemany321 "[[],[],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}]]" --from ${key} \
    --gas auto --gas-adjustment 1.5 --gas-prices 1.25usix -y --node ${RPC_ENDPOINT} --chain-id ${CHAIN_ID} | grep -q 'msg_index: 0'; then
    echo "✅ Test Multi Action(one token multi action) - Case 321"
    TOTAL=$((TOTAL+1))
    PASSED=$((PASSED+1))
...
#read -p "Press enter to continue"
if sixd tx nftmngr perform-multi-token-action dee_dev01.multiaction 16 start_mission,test_read_nft,test_split onemany330 "[[],[],[]]" --from ${key} \
    --gas auto --gas-adjustment 1.5 --gas-prices 1.25usix -y --node ${RPC_ENDPOINT} --chain-id ${CHAIN_ID} | grep -q 'msg_index: 0'; then
    echo "✅ Test Multi Action(one token multi action) - Case 330"
    TOTAL=$((TOTAL+1))
    PASSED=$((PASSED+1))
...
#read -p "Press enter to continue"
if sixd tx nftmngr perform-multi-token-action dee_dev01.multiaction 16 transfer,transfer,transfer,transfer onemany404 "[[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}]]" --from ${key} \
    --gas auto --gas-adjustment 1.5 --gas-prices 1.25usix -y --node ${RPC_ENDPOINT} --chain-id ${CHAIN_ID} | grep -q 'msg_index: 0'; then
    echo "✅ Test Multi Action(one token multi action) - Case 404"
    TOTAL=$((TOTAL+1))
    PASSED=$((PASSED+1))
...
#read -p "Press enter to continue"
if sixd tx nftmngr perform-multi-token-action dee_dev01.multiaction 17 start_mission,transfer,transfer,transfer onemany413 "[[],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}]]" --from ${key} \
    --gas auto --gas-adjustment 1.5 --gas-prices 1.25usix -y --node ${RPC_ENDPOINT} --chain-id ${CHAIN_ID}  | grep -q 'msg_index: 0'; then
    echo "✅ Test Multi Action(one token multi action) - Case 413"
    TOTAL=$((TOTAL+1))
    PASSED=$((PASSED+1))
...
#read -p "Press enter to continue"
if sixd tx nftmngr perform-multi-token-action dee_dev01.multiaction 18 start_mission,test_read_nft,transfer,transfer onemany422 "[[],[],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}]]" --from ${key} \
    --gas auto --gas-adjustment 1.5 --gas-prices 1.25usix -y --node ${RPC_ENDPOINT} --chain-id ${CHAIN_ID} | grep -q 'msg_index: 0'; then
    echo "✅ Test Multi Action(one token multi action) - Case 422"
    TOTAL=$((TOTAL+1))
    PASSED=$((PASSED+1))
...
#read -p "Press enter to continue"
if sixd tx nftmngr perform-multi-token-action dee_dev01.multiaction 19 start_mission,test_read_nft,test_split,transfer onemany431 "[[],[],[],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}]]" --from ${key} \
    --gas auto --gas-adjustment 1.5 --gas-prices 1.25usix -y --node ${RPC_ENDPOINT} --chain-id ${CHAIN_ID} | grep -q 'msg_index: 0'; then
    echo "✅ Test Multi Action(one token multi action) - Case 431"
    TOTAL=$((TOTAL+1))
    PASSED=$((PASSED+1))
...
#read -p "Press enter to continue"
if sixd tx nftmngr perform-multi-token-action dee_dev01.multiaction 20 start_mission,test_read_nft,test_split,test_lowercase onemany440 "[[],[],[],[]]" --from ${key} \
    --gas auto --gas-adjustment 1.5 --gas-prices 1.25usix -y --node ${RPC_ENDPOINT} --chain-id ${CHAIN_ID} | grep -q 'msg_index: 0'; then
    echo "✅ Test Multi Action(one token multi action) - Case 440"
    TOTAL=$((TOTAL+1))
    PASSED=$((PASSED+1))
...
#read -p "Press enter to continue"
if sixd tx nftmngr perform-multi-token-action dee_dev01.multiaction 20,20 transfer,transfer manymany202 "[[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}]]" --from ${key} \
    --gas auto --gas-adjustment 1.5 --gas-prices 1.25usix -y --node ${RPC_ENDPOINT} --chain-id ${CHAIN_ID} | grep -q 'msg_index: 0'; then
    echo "✅ Test Multi Action(multi token multi action) - Case 202"
    TOTAL=$((TOTAL+1))
    PASSED=$((PASSED+1))
...
#read -p "Press enter to continue"
if sixd tx nftmngr perform-multi-token-action dee_dev01.multiaction 21,21 start_mission,transfer manymany211 "[[],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}]]" --from ${key} \
    --gas auto --gas-adjustment 1.5 --gas-prices 1.25usix -y --node ${RPC_ENDPOINT} --chain-id ${CHAIN_ID} | grep -q 'msg_index: 0'; then
    echo "✅ Test Multi Action(multi token multi action) - Case 211"
    TOTAL=$((TOTAL+1))
    PASSED=$((PASSED+1))
...
#read -p "Press enter to continue"
if sixd tx nftmngr perform-multi-token-action dee_dev01.multiaction 22,22 start_mission,test_read_nft manymany220 "[[],[]]" --from ${key} \
    --gas auto --gas-adjustment 1.5 --gas-prices 1.25usix -y --node ${RPC_ENDPOINT}  --chain-id ${CHAIN_ID} | grep -q 'msg_index: 0'; then
    echo "✅ Test Multi Action(multi token multi action) - Case 220"
    TOTAL=$((TOTAL+1))
    PASSED=$((PASSED+1))
...
#read -p "Press enter to continue"
if sixd tx nftmngr perform-multi-token-action dee_dev01.multiaction 22,22,22 transfer,transfer,transfer manymany303 "[[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}]]" --from ${key} \
    --gas auto --gas-adjustment 1.5 --gas-prices 1.25usix -y --node ${RPC_ENDPOINT} --chain-id ${CHAIN_ID} | grep -q 'msg_index: 0'; then
    echo "✅ Test Multi Action(multi token multi action) - Case 303"
    TOTAL=$((TOTAL+1))
    PASSED=$((PASSED+1))
...
#read -p "Press enter to continue"
if sixd tx nftmngr perform-multi-token-action dee_dev01.multiaction 23,23,23 start_mission,transfer,transfer manymany312 "[[],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}]]" --from ${key} \
    --gas auto --gas-adjustment 1.5 --gas-prices 1.25usix -y --node ${RPC_ENDPOINT} --chain-id ${CHAIN_ID} | grep -q 'msg_index: 0'; then
    echo "✅ Test Multi Action(multi token multi action) - Case 312"
    TOTAL=$((TOTAL+1))
    PASSED=$((PASSED+1))
...
#read -p "Press enter to continue"
if sixd tx nftmngr perform-multi-token-action dee_dev01.multiaction 24,24,24 start_mission,test_read_nft,transfer manymany321 "[[],[],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}]]" --from ${key} \
    --gas auto --gas-adjustment 1.5 --gas-prices 1.25usix -y --node ${RPC_ENDPOINT} --chain-id ${CHAIN_ID} | grep -q 'msg_index: 0'; then
    echo "✅ Test Multi Action(multi token multi action) - Case 321"
    TOTAL=$((TOTAL+1))
    PASSED=$((PASSED+1))
...
#read -p "Press enter to continue"
if sixd tx nftmngr perform-multi-token-action dee_dev01.multiaction 25,25,25 start_mission,test_read_nft,test_split manymany330 "[[],[],[]]" --from ${key} \
    --gas auto --gas-adjustment 1.5 --gas-prices 1.25usix -y --node ${RPC_ENDPOINT} --chain-id ${CHAIN_ID} | grep -q 'msg_index: 0'; then 
    echo "✅ Test Multi Action(multi token multi action) - Case 330"
    TOTAL=$((TOTAL+1))
    PASSED=$((PASSED+1))
...
#read -p "Press enter to continue"
if sixd tx nftmngr perform-multi-token-action dee_dev01.multiaction 25,25,25,25 transfer,transfer,transfer,transfer manymany404 "[[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}]]" --from ${key} \
    --gas auto --gas-adjustment 1.5 --gas-prices 1.25usix -y --node ${RPC_ENDPOINT} --chain-id ${CHAIN_ID} | grep -q 'msg_index: 0'; then
    echo "✅ Test Multi Action(multi token multi action) - Case 404"
    TOTAL=$((TOTAL+1))
    PASSED=$((PASSED+1))
...
#read -p "Press enter to continue"
if sixd tx nftmngr perform-multi-token-action dee_dev01.multiaction 26,26,26,26 start_mission,transfer,transfer,transfer manymany413 "[[],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}]]" --from ${key} \
    --gas auto --gas-adjustment 1.5 --gas-prices 1.25usix -y --node ${RPC_ENDPOINT} --chain-id ${CHAIN_ID} | grep -q 'msg_index: 0'; then
    echo "✅ Test Multi Action(multi token multi action) - Case 413"
    TOTAL=$((TOTAL+1))
    PASSED=$((PASSED+1))
...
#read -p "Press enter to continue"
if sixd tx nftmngr perform-multi-token-action dee_dev01.multiaction 27,27,27,27 start_mission,test_read_nft,transfer,transfer manymany422 "[[],[],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}]]" --from ${key} \
    --gas auto --gas-adjustment 1.5 --gas-prices 1.25usix -y --node ${RPC_ENDPOINT} --chain-id ${CHAIN_ID} | grep -q 'msg_index: 0'; then
    echo "✅ Test Multi Action(multi token multi action) - Case 422"
    TOTAL=$((TOTAL+1))
    PASSED=$((PASSED+1))
...
#read -p "Press enter to continue"
if sixd tx nftmngr perform-multi-token-action dee_dev01.multiaction 28,28,28,28 start_mission,test_read_nft,test_split,transfer manymany431 "[[],[],[],[{\"name\":\"points\",\"value\":\"20\"},{\"name\":\"token_id\",\"value\":\"1\"}]]" --from ${key} \
    --gas auto --gas-adjustment 1.5 --gas-prices 1.25usix -y --node ${RPC_ENDPOINT} --chain-id ${CHAIN_ID} | grep -q 'msg_index: 0'; then
    echo "✅ Test Multi Action(multi token multi action) - Case 431"
    TOTAL=$((TOTAL+1))
    PASSED=$((PASSED+1))
...
#read -p "Press enter to continue"
if sixd tx nftmngr perform-multi-token-action dee_dev01.multiaction 29 start_mission,test_read_nft,test_split,test_lowercase manymany440 "[[],[],[],[]]" --from ${key} \
    --gas auto --gas-adjustment 1.5 --gas-prices 1.25usix -y --node ${RPC_ENDPOINT} --chain-id ${CHAIN_ID} | grep -q 'msg_index: 0'; then
    echo "✅ Test Multi Action(multi token multi action) - Case 440"
    TOTAL=$((TOTAL+1))
    PASSED=$((PASSED+1))
