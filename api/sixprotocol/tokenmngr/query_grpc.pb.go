...
func (c *queryClient) Token(ctx context.Context, in *QueryGetTokenRequest, opts ...grpc.CallOption) (*QueryGetTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_Token_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) TokenAll(ctx context.Context, in *QueryAllTokenRequest, opts ...grpc.CallOption) (*QueryAllTokenResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_TokenAll_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Mintperm(ctx context.Context, in *QueryGetMintpermRequest, opts ...grpc.CallOption) (*QueryGetMintpermResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_Mintperm_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) MintpermAll(ctx context.Context, in *QueryAllMintpermRequest, opts ...grpc.CallOption) (*QueryAllMintpermResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_MintpermAll_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) TokenBurn(ctx context.Context, in *QueryGetTokenBurnRequest, opts ...grpc.CallOption) (*QueryGetTokenBurnResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_TokenBurn_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) TokenBurnAll(ctx context.Context, in *QueryAllTokenBurnRequest, opts ...grpc.CallOption) (*QueryAllTokenBurnResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_TokenBurnAll_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) Options(ctx context.Context, in *QueryGetOptionsRequest, opts ...grpc.CallOption) (*QueryGetOptionsResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_Options_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *queryClient) ListPrecompile(ctx context.Context, in *QueryListPrecompileRequest, opts ...grpc.CallOption) (*QueryListPrecompileResponse, error) {
	...
	err := c.cc.Invoke(ctx, Query_ListPrecompile_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedQueryServer) ListPrecompile(context.Context, *QueryListPrecompileRequest) (*QueryListPrecompileResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method ListPrecompile not implemented")
}
