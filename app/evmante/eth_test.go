...
import (
	...
	"github.com/thesixnetwork/six-protocol/app/evmante"
...
func (suite EVMAnteTestSuite) TestEthSigVerificationDecorator() {
	...
	for _, tc := range testCases {
		suite.Run(tc.name, func() {
			...
			suite.SetupTest()
			dec := evmante.NewEthSigVerificationDecorator(suite.app.EVMKeeper)
...
func (suite EVMAnteTestSuite) TestNewEthAccountVerificationDecorator() {
	dec := evmante.NewEthAccountVerificationDecorator(
...
func (suite EVMAnteTestSuite) TestEthNonceVerificationDecorator() {
	suite.SetupTest()
	dec := evmante.NewEthIncrementSenderSequenceDecorator(suite.app.AccountKeeper)
...
func (suite EVMAnteTestSuite) TestEthGasConsumeDecorator() {
	dec := evmante.NewEthGasConsumeDecorator(suite.app.EVMKeeper, config.DefaultMaxTxGasWanted)
...
func (suite EVMAnteTestSuite) TestCanTransferDecorator() {
	dec := evmante.NewCanTransferDecorator(suite.app.EVMKeeper)
...
func (suite EVMAnteTestSuite) TestEthIncrementSenderSequenceDecorator() {
	dec := evmante.NewEthIncrementSenderSequenceDecorator(suite.app.AccountKeeper)
	addr, privKey := tests.NewAddrKey()
...
func (suite EVMAnteTestSuite) TestEthSetupContextDecorator() {
