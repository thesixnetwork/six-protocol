...
import (
	...
	"github.com/thesixnetwork/six-protocol/ethereum/eip712"
	"github.com/thesixnetwork/six-protocol/types"
	...
	ante "github.com/thesixnetwork/six-protocol/app/evmante"
	"github.com/thesixnetwork/six-protocol/encoding"
	"github.com/thesixnetwork/six-protocol/tests"
...
func (suite *EVMAnteTestSuite) StateDB() *statedb.StateDB {
	return statedb.New(suite.ctx, suite.app.EVMKeeper, statedb.NewEmptyTxConfig(common.BytesToHash(suite.ctx.HeaderHash().Bytes())))
}

func (suite *EVMAnteTestSuite) SetupTest() {
	checkTx := false

	suite.app = app.Setup(checkTx, func(app *app.App, genesis app.GenesisState) app.GenesisState {
...
func (s *EVMAnteTestSuite) BuildTestEthTx(
	from common.Address,
	to common.Address,
	amount *big.Int,
	input []byte,
...
func (suite *EVMAnteTestSuite) CreateTestTx(
...
func (suite *EVMAnteTestSuite) CreateTestTxBuilder(
	msg *evmtypes.MsgEthereumTx, priv cryptotypes.PrivKey, accNum uint64, signCosmosTx bool,
	unsetExtensionOptions ...bool,
) client.TxBuilder {
...
func (suite *EVMAnteTestSuite) CreateTestCosmosTxBuilder(gasPrice sdk.Int, denom string, msgs ...sdk.Msg) client.TxBuilder {
	txBuilder := suite.clientCtx.TxConfig.NewTxBuilder()
...
func (suite *EVMAnteTestSuite) CreateTestEIP712TxBuilderMsgSend(from sdk.AccAddress, priv cryptotypes.PrivKey, chainId string, gas uint64, gasAmount sdk.Coins) client.TxBuilder {
	// Build MsgSend
...
func (suite *EVMAnteTestSuite) CreateTestEIP712TxBuilderMsgDelegate(from sdk.AccAddress, priv cryptotypes.PrivKey, chainId string, gas uint64, gasAmount sdk.Coins) client.TxBuilder {
	// Build MsgSend
...
func (suite *EVMAnteTestSuite) CreateTestEIP712CosmosTxBuilder(
