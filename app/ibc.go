...
func (app *App) _(_ servertypes.AppOptions) error {
	...
	transferIBCModule := ibcfee.NewIBCMiddleware(transfer.NewIBCModule(app.TransferKeeper), app.IBCFeeKeeper)
	...
	app.ScopedTransferKeeper = scopedIBCTransferKeeper
