...
export interface AminoMsgCreateToken extends AminoMsg {
  readonly type: "tokenmngr/CreateToken";
  readonly value: {
    ...
    readonly denomMetaData: string;
    readonly mintee: string;
  };
}

export interface AminoMsgMint extends AminoMsg {
  readonly type: "tokenmngr/Mint";
  readonly value: {
    /** Bech32 account address */
    readonly creator: string;
    /** Bech32 account address */
...
export interface AminoMsgCreateMintperm extends AminoMsg {
  readonly type: "tokenmngr/CreateMintperm";
  readonly value: {
    /** Bech32 account address */
    readonly creator: string;
    /** Bech32 account address */
...
export interface AminoMsgCreateBinding extends AminoMsg {
  readonly type: "evmbind/MsgCreateBinding";
  readonly value: {
    /** Bech32 account address */
    readonly creator: string;
    /** Bech32 account address */
    ...
    readonly signMessage: string;
  };
}

export interface AminoMsgUseNftByEVM extends AminoMsg {
  readonly type: "consume/MsgUseNftByEVM";
  readonly value: {
    readonly creator: string;
    readonly token: string;
    readonly ethSignature: string;
...
export function createTokenAdminoTypes(): Record<string, AminoConverter> {
  return {
    "/thesixnetwork.sixprotocol.tokenmngr.MsgCreateToken": {
      aminoType: "tokenmngr/CreateToken",
      toAmino: ({
        creator,
        name,
        maxSupply,
        denomMetaData,
        mintee
      }: MsgCreateToken): AminoMsgCreateToken["value"] => ({
        creator: creator,
        name: name,
        maxSupply: maxSupply,
      ...
      fromAmino: ({
        ...
        denomMetaData,
        mintee
      }: AminoMsgCreateToken["value"]): MsgCreateToken => ({
        creator: creator,
        name: name,
        maxSupply: maxSupply,
        denomMetaData: denomMetaData,
...
export function mintTokenAdminoTypes(): Record<string, AminoConverter> {
  return {
    "/thesixnetwork.sixprotocol.tokenmngr.MsgMint": {
      aminoType: "tokenmngr/MsgMint",
      toAmino: ({
        creator,
        amount,
        token
...
export function createMintpermAdminoTypes(): Record<string, AminoConverter> {
  return {
    "/thesixnetwork.sixprotocol.tokenmngr.MsgCreateMintperm": {
      aminoType: "tokenmngr/CreateMintperm",
      toAmino: ({
        creator,
        token,
        address
      }: MsgCreateMintperm): AminoMsgCreateMintperm["value"] => ({
        creator: creator,
        token: token,
        address: address
      }),
      fromAmino: ({
        ...
        token,
        address
      }: AminoMsgCreateMintperm["value"]): MsgCreateMintperm => ({
        creator: creator,
        token: token,
        address: address
      })
...
export function createBindingAdminoTypes(): Record<string, AminoConverter> {
  return {
    "/thesixnetwork.sixprotocol.evmbind.MsgCreateBinding": {
      aminoType: "evmbind/MsgCreateBinding",
      toAmino: ({
        creator,
        ethAddress,
        ethSignature,
        signMessage
      }: MsgCreateBinding): AminoMsgCreateBinding["value"] => ({
        creator: creator,
      ...
      fromAmino: ({
        ...
        ethSignature,
        signMessage
      }: AminoMsgCreateBinding["value"]): MsgCreateBinding => ({
        creator: creator,
        ethAddress: ethAddress,
        ethSignature: ethSignature,
        signMessage: signMessage
...
export function createUseNftByEVMAdminoTypes(): Record<string, AminoConverter> {
  return {
    "/thesixnetwork.sixprotocol.consume.MsgUseNftByEVM": {
      aminoType: "consume/MsgUseNftByEVM",
      toAmino: ({
        creator,
        token,
        ethSignature,
        signMessage,
        ethAddress
      }: MsgUseNftByEVM): AminoMsgUseNftByEVM["value"] => ({
        creator: creator,
        token: token,
        ethSignature: ethSignature,
        signMessage: signMessage,
      ...
      fromAmino: ({
        ...
        signMessage,
        ethAddress
      }: AminoMsgUseNftByEVM["value"]): MsgUseNftByEVM => ({
        creator: creator,
        token: token,
        ethSignature: ethSignature,
        signMessage: signMessage,
