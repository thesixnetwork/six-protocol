...
replace (
	...
	github.com/evmos/ethermint => github.com/thesixnetwork/ethermint v0.18.1-0.20230418104205-75ac6de3fba3
	...
	github.com/thesixnetwork/sixnft => github.com/thesixnetwork/sixnft v0.9.2-b
