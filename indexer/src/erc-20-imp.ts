...
export function handleAllAssetUpdatersRevoked(event: AllAssetUpdatersRevokedEvent): void {
  let entity = new AllAssetUpdatersRevoked(event.transaction.hash.concatI32(event.logIndex.toI32()));
...
export function handleAssetUpdaterAdded(event: AssetUpdaterAddedEvent): void {
  let entity = new AssetUpdaterAdded(event.transaction.hash.concatI32(event.logIndex.toI32()));
...
export function handleAssetUpdaterRemoved(event: AssetUpdaterRemovedEvent): void {
  let entity = new AssetUpdaterRemoved(event.transaction.hash.concatI32(event.logIndex.toI32()));
  entity.updater = event.params.updater;
...
export function handleHolderAdded(event: HolderAddedEvent): void {
  let entity = new HolderAdded(event.transaction.hash.concatI32(event.logIndex.toI32()));
...
export function handleHolderUpdated(event: HolderUpdatedEvent): void {
  let entity = new HolderUpdated(event.transaction.hash.concatI32(event.logIndex.toI32()));
  entity.holder = event.params.holder;
...
export function handleMultipleHoldersAdded(event: MultipleHoldersAddedEvent): void {
  let entity = new MultipleHoldersAdded(event.transaction.hash.concatI32(event.logIndex.toI32()));
...
export function handleMultipleHoldersUpdated(event: MultipleHoldersUpdatedEvent): void {
  let entity = new MultipleHoldersUpdated(event.transaction.hash.concatI32(event.logIndex.toI32()));
  entity.holders = event.params.holders;
