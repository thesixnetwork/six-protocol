...
export function createAllAssetUpdatersRevokedEvent(): AllAssetUpdatersRevoked {
  let allAssetUpdatersRevokedEvent = changetype<AllAssetUpdatersRevoked>(newMockEvent());
...
export function createAssetUpdaterAddedEvent(updater: Address): AssetUpdaterAdded {
  let assetUpdaterAddedEvent = changetype<AssetUpdaterAdded>(newMockEvent());

  assetUpdaterAddedEvent.parameters = new Array();

  assetUpdaterAddedEvent.parameters.push(new ethereum.EventParam("updater", ethereum.Value.fromAddress(updater)));

  return assetUpdaterAddedEvent;
}

export function createAssetUpdaterRemovedEvent(updater: Address): AssetUpdaterRemoved {
  let assetUpdaterRemovedEvent = changetype<AssetUpdaterRemoved>(newMockEvent());

  assetUpdaterRemovedEvent.parameters = new Array();

  assetUpdaterRemovedEvent.parameters.push(new ethereum.EventParam("updater", ethereum.Value.fromAddress(updater)));

  return assetUpdaterRemovedEvent;
}

export function createHolderAddedEvent(holder: string, amount: BigInt, externalId: string): HolderAdded {
  let holderAddedEvent = changetype<HolderAdded>(newMockEvent());

  holderAddedEvent.parameters = new Array();

  holderAddedEvent.parameters.push(new ethereum.EventParam("holder", ethereum.Value.fromString(holder)));
  holderAddedEvent.parameters.push(new ethereum.EventParam("amount", ethereum.Value.fromUnsignedBigInt(amount)));
  holderAddedEvent.parameters.push(new ethereum.EventParam("externalId", ethereum.Value.fromString(externalId)));
...
export function createHolderUpdatedEvent(
  ...
  holderUpdatedEvent.parameters.push(new ethereum.EventParam("holder", ethereum.Value.fromString(holder)));
  holderUpdatedEvent.parameters.push(
    new ethereum.EventParam("previousAmount", ethereum.Value.fromUnsignedBigInt(previousAmount))
  );
  holderUpdatedEvent.parameters.push(new ethereum.EventParam("amount", ethereum.Value.fromUnsignedBigInt(amount)));
  holderUpdatedEvent.parameters.push(new ethereum.EventParam("externalId", ethereum.Value.fromString(externalId)));
...
export function createMultipleHoldersAddedEvent(
  ...
  let multipleHoldersAddedEvent = changetype<MultipleHoldersAdded>(newMockEvent());
  ...
  multipleHoldersAddedEvent.parameters.push(
    new ethereum.EventParam("externalIds", ethereum.Value.fromStringArray(externalIds))
  );
...
export function createMultipleHoldersUpdatedEvent(
  ...
  let multipleHoldersUpdatedEvent = changetype<MultipleHoldersUpdated>(newMockEvent());
  ...
  multipleHoldersUpdatedEvent.parameters.push(
    new ethereum.EventParam("previousAmounts", ethereum.Value.fromUnsignedBigIntArray(previousAmounts))
  );
  multipleHoldersUpdatedEvent.parameters.push(
    new ethereum.EventParam("amounts", ethereum.Value.fromUnsignedBigIntArray(amounts))
  );
  multipleHoldersUpdatedEvent.parameters.push(
    new ethereum.EventParam("holdersExternalIds", ethereum.Value.fromStringArray(holdersExternalIds))
  );
