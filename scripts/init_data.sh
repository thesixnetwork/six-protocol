...
sixd tx nftoracle create-action-signer-config baobab https://api.baobab.klaytn.net:8651 0xe2762507764fE0d20bfb490Fc6Eb3EB837042c35 idc idc --from super-admin -y --node ${RPC_ENDPOINT} --chain-id ${CHAIN_ID} --gas auto --gas-adjustment 1.5 --gas-prices 1.25usix
