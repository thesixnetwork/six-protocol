...
case $choice in
    1) echo "Showing Schema"
        ...
        sixd q nftmngr show-nft-schema ${schema_code} --chain-id testnet --output json | jq .
        ;;
    2) echo "Showing NFT"
        read -p "Enter Schema Code: " schema_code 
        ...
        sixd q nftmngr show-nft-data ${schema_code} ${token_id} --chain-id testnet --output json | jq .
        ;;
    3) echo "Mockup Token"
        read -p "Enter Schema Code: " schema_code 
        read -p "Enter Token ID: " token_id
        ...
        sixd tx nftmngr create-metadata "${schema_code}" ${token_id} --chain-id testnet --from alice --gas auto --gas-adjustment 1.5 --gas-prices 0.1usix -y \
            ${BASE64_META}
        ;;
    4) echo "Do Action"
        read -p "Enter Schema Code: " schema_code 
        ...
        sixd tx nftmngr perform-action-by-nftadmin ${schema_code} ${token_id} ${action} --chain-id testnet --from alice --gas auto --gas-adjustment 1.5 --gas-prices 0.1usix -y
        ;;
    5) echo "Set NFT Attribute"
        ...
        sixd tx nftmngr set-nft-attribute ${schema_code} ${BASE64_ATTR} --from alice --chain-id testnet --gas auto --gas-adjustment 1.5 --gas-prices 0.1usix -y
        ;;
    6) echo "Oracle - Create Mint Request"
        ...
        sixd tx nftoracle create-mint-request ${schema_code} ${token_id} ${require_confirmations} --from alice --chain-id testnet --gas auto --gas-adjustment 1.5 --gas-prices 0.1usix -y
        ;;
    ...
    8) echo "Oracle - Submit Mint Response"
        ...
        sixd tx nftoracle submit-mint-response ${mint_request_id} ${BASE64_ORIGINDATA} --from ${oracle_key_name} --chain-id testnet --gas auto --gas-adjustment 1.5 --gas-prices 0.1usix -y
        ;;
    9) echo "Oracle - Create Action Request"
        ...
        sixd tx nftoracle create-action-request ethereum ${BASE64_ACTION_SIG} ${require_confirmations} --from alice --chain-id testnet --gas auto --gas-adjustment 1.5 --gas-prices 0.1usix -y 
        ;;
    ...
    11) echo "Oracle - Submit Action Response"
        ...
        sixd tx nftoracle submit-action-response ${action_request_id} ${BASE64_ORIGINDATA} --from ${oracle_key_name} --chain-id testnet --gas auto --gas-adjustment 1.5 --gas-prices 0.1usix -y
        ;;
    12) echo "Oracle - Create Verify Schema Request"
        ...
        sixd tx nftoracle create-verify-collection-owner-request ${schema_code} ${BASE64_VERIFY_SIG} ${require_confirmations} --from alice --chain-id testnet --gas auto --gas-adjustment 1.5 --gas-prices 0.1usix -y
        ;;
    ...
    14) echo "Oracle - Submit Verify Response"
        ...
        sixd tx nftoracle submit-verify-collection-owner ${verfiry_request_id} ${schema_code} ${BASE64_ORIGINDATA} --from ${oracle_key_name} --gas auto --chain-id testnet --gas-adjustment 1.5 --gas-prices 0.1usix -y
        ;;
     15) echo "Add Attribute"
        ...
        sixd tx nftmngr add-attribute ${schema_code} ${location} ${BASE64_ATTRIBUTE} --from alice --chain-id testnet --gas auto --gas-adjustment 1.5 --gas-prices 0.1usix -y \
            --chain-id sixnft
        ;;
     16) echo "Add Action"
        read -p "Enter Schema Code: " schema_code 
        ...
        sixd tx nftmngr add-action ${schema_code} ${BASE64_ACTION} --from alice --chain-id testnet --gas auto --gas-adjustment 1.5 --gas-prices 0.1usix -y \
            --chain-id sixnft
        ;;
    *) echo "Invalid choice"
       ;;
