...
case $choice in
    ...
    3) echo "Mockup Token"
        ...
        BASE64_META=`cat nft-data-old.json | sed "s/TOKENID/${token_id}/g"  | sed "s/SCHEMA_CODE/${schema_code}/g" | base64 | tr -d '\n'`
        sixd tx nftmngr create-metadata "${schema_code}" ${token_id} --chain-id ${CHAIN_ID} --node ${RPC_ENDPOINT} --from alice --gas auto --gas-adjustment 1.5 --gas-prices 0.1usix -y \
            ${BASE64_META}
        ;;
    4) echo "Do Action"
        read -p "Enter Schema Code: " schema_code 
        ...
        sixd tx nftmngr perform-action-by-nftadmin ${schema_code} ${token_id} ${action} --chain-id ${CHAIN_ID} --node ${RPC_ENDPOINT} --from alice --gas auto --gas-adjustment 1.5 --gas-prices 0.1usix -y
        ;;
    5) echo "Set NFT Attribute"
        ...
        sixd tx nftmngr set-nft-attribute ${schema_code} ${BASE64_ATTR} --from alice --chain-id ${CHAIN_ID} --node ${RPC_ENDPOINT} --gas auto --gas-adjustment 1.5 --gas-prices 0.1usix -y
        ;;
    6) echo "Oracle - Create Mint Request"
        ...
        sixd tx nftoracle create-mint-request ${schema_code} ${token_id} ${require_confirmations} --from alice --chain-id ${CHAIN_ID} --node ${RPC_ENDPOINT} --gas auto --gas-adjustment 1.5 --gas-prices 0.1usix -y
        ;;
    7) echo "Oracle - Get Mint Request"
        read -p "Mint Request ID: " mint_request_id 
        sixd q nftoracle show-mint-request ${mint_request_id} --output json | jq .
        ;;
    8) echo "Oracle - Submit Mint Response"
        ...
        sixd tx nftoracle submit-mint-response ${mint_request_id} ${BASE64_ORIGINDATA} --from ${oracle_key_name} --chain-id ${CHAIN_ID} --node ${RPC_ENDPOINT} --gas auto --gas-adjustment 1.5 --gas-prices 0.1usix -y
        ;;
    9) echo "Oracle - Create Action Request"
        ...
        sixd tx nftoracle create-action-request ethereum ${BASE64_ACTION_SIG} ${require_confirmations} --from alice --chain-id ${CHAIN_ID} --node ${RPC_ENDPOINT} --gas auto --gas-adjustment 1.5 --gas-prices 0.1usix -y 
        ;;
    10) echo "Oracle - Get Action Request"
        read -p "Action Request ID: " action_request_id 
        sixd q nftoracle show-action-request ${action_request_id} --output json | jq .
        ;;
    11) echo "Oracle - Submit Action Response"
        ...
        sixd tx nftoracle submit-action-response ${action_request_id} ${BASE64_ORIGINDATA} --from ${oracle_key_name} --chain-id ${CHAIN_ID} --node ${RPC_ENDPOINT} --gas auto --gas-adjustment 1.5 --gas-prices 0.1usix -y
        ;;
    12) echo "Oracle - Create Verify Schema Request"
        ...
        sixd tx nftoracle create-verify-collection-owner-request ${schema_code} ${BASE64_VERIFY_SIG} ${require_confirmations} --from alice --chain-id ${CHAIN_ID} --node ${RPC_ENDPOINT} --gas auto --gas-adjustment 1.5 --gas-prices 0.1usix -y
        ;;
    13) echo "Oracle - Get Verify Request"
        read -p "Verify Request ID: " verfiry_request_id 
        sixd q nftoracle show-collection-owner-request ${verfiry_request_id} --output json | jq .
        ;;
    14) echo "Oracle - Submit Verify Response"
        ...
        sixd tx nftoracle submit-verify-collection-owner ${verfiry_request_id} ${schema_code} ${BASE64_ORIGINDATA} --from ${oracle_key_name} --gas auto --chain-id ${CHAIN_ID} --node ${RPC_ENDPOINT} --gas-adjustment 1.5 --gas-prices 0.1usix -y
        ;;
     15) echo "Add Attribute"
        ...
        sixd tx nftmngr add-attribute ${schema_code} ${location} ${BASE64_ATTRIBUTE} --from alice --chain-id ${CHAIN_ID} --node ${RPC_ENDPOINT} --gas auto --gas-adjustment 1.5 --gas-prices 0.1usix -y \
            --chain-id sixnft
        ;;
     16) echo "Add Action"
        read -p "Enter Schema Code: " schema_code 
        ...
        sixd tx nftmngr add-action ${schema_code} ${BASE64_ACTION} --from alice --chain-id ${CHAIN_ID} --node ${RPC_ENDPOINT} --gas auto --gas-adjustment 1.5 --gas-prices 0.1usix -y \
            --chain-id sixnft
        ;;
    *) echo "Invalid choice"
       ;;
