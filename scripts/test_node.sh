...
#
# Examples:
# CHAIN_ID="localchain_9000-1" HOME_DIR="~/.sixprotocol" BLOCK_TIME="1000ms" CLEAN=true sh scripts/test_node.sh
# CHAIN_ID="localchain_9000-2" HOME_DIR="~/.sixprotocol" CLEAN=true RPC=36657 REST=2317 PROFF=6061 P2P=36656 GRPC=8090 GRPC_WEB=8091 ROSETTA=8081 BLOCK_TIME="500ms" sh scripts/test_node.sh
...
export HOME_DIR=$(eval echo "${HOME_DIR:-"~/.six"}")
export BINARY=${BINARY:-sixd}
export DENOM=${DENOM:-usix}
...
from_scratch () {
  ...
  # six140fehngcrxvhdt84x729p3f0qmkmea8nrthegq
  ...
  # six1r6yue0vuyj9m7xw78npspt9drq2tmtvg0k3cmt
  ...
  update_test_genesis '.app_state["feemarket"]["params"]["base_fee"]="5000000000000"'
