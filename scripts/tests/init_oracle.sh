...
sixd tx nftadmin grant-permission oracle_admin $(sixd keys show alice -a) --from super-admin --gas auto --gas-adjustment 1.5 --gas-prices 2usix -y --node ${RPC_ENDPOINT} --chain-id testnet
sixd tx nftoracle set-minimum-confirmation 3 --from super-admin -y --node ${RPC_ENDPOINT} --chain-id testnet --gas-prices 2usix
