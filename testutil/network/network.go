...
func DefaultConfig() Config {
	...
	return Config{
		...
		NumValidators:     4,
		BondDenom:         "usix",
		MinGasPrices:      fmt.Sprintf("1.15%s", "usix"),
		AccountTokens:     sdk.TokensFromConsensusPower(1e6, DefaultPowerReduction),
		StakingTokens:     sdk.TokensFromConsensusPower(5*1e6, DefaultPowerReduction),
		BondedTokens:      sdk.TokensFromConsensusPower(1e6, DefaultPowerReduction),
...
func New(l Logger, cfg Config) (*Network, error) {
