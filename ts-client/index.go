...
import { IgntModule as SixprotocolNftadmin, msgTypes as SixprotocolNftadminMsgTypes } from './sixprotocol.nftadmin'
import { IgntModule as SixprotocolNftmngr, msgTypes as SixprotocolNftmngrMsgTypes } from './sixprotocol.nftmngr'
import { IgntModule as SixprotocolNftoracle, msgTypes as SixprotocolNftoracleMsgTypes } from './sixprotocol.nftoracle'
import { IgntModule as SixprotocolProtocoladmin, msgTypes as SixprotocolProtocoladminMsgTypes } from './sixprotocol.protocoladmin'
import { IgntModule as SixprotocolTokenmngr, msgTypes as SixprotocolTokenmngrMsgTypes } from './sixprotocol.tokenmngr'


const Client = IgniteClient.plugin([
    CosmosAuthV1Beta1, CosmosAuthzV1Beta1, CosmosBankV1Beta1, CosmosBaseNodeV1Beta1, CosmosBaseTendermintV1Beta1, CosmosCircuitV1, CosmosConsensusV1, CosmosCrisisV1Beta1, CosmosDistributionV1Beta1, CosmosEvidenceV1Beta1, CosmosFeegrantV1Beta1, CosmosGovV1, CosmosGovV1Beta1, CosmosGroupV1, CosmosMintV1Beta1, CosmosNftV1Beta1, CosmosParamsV1Beta1, CosmosSlashingV1Beta1, CosmosStakingV1Beta1, CosmosTxV1Beta1, CosmosUpgradeV1Beta1, CosmosVestingV1Beta1, IbcApplicationsFeeV1, IbcApplicationsInterchainAccountsControllerV1, IbcApplicationsInterchainAccountsHostV1, IbcApplicationsTransferV1, IbcCoreChannelV1, IbcCoreClientV1, IbcCoreConnectionV1, SixprotocolNftadmin, SixprotocolNftmngr, SixprotocolNftoracle, SixprotocolProtocoladmin, SixprotocolTokenmngr
]);
...
const registry = new Registry([
  ...
  ...SixprotocolNftadminMsgTypes,
  ...SixprotocolNftmngrMsgTypes,
  ...SixprotocolNftoracleMsgTypes,
  ...SixprotocolProtocoladminMsgTypes,
  ...SixprotocolTokenmngrMsgTypes,
