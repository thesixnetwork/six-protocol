...
import { StakeAuthorization } from "thesixnetwork-six-protocol-client-ts/cosmos.staking.v1beta1/types"
import { StakeAuthorization_Validators } from "thesixnetwork-six-protocol-client-ts/cosmos.staking.v1beta1/types"
import { LastValidatorPower } from "thesixnetwork-six-protocol-client-ts/cosmos.staking.v1beta1/types"
import { HistoricalInfo } from "thesixnetwork-six-protocol-client-ts/cosmos.staking.v1beta1/types"
import { CommissionRates } from "thesixnetwork-six-protocol-client-ts/cosmos.staking.v1beta1/types"
import { Commission } from "thesixnetwork-six-protocol-client-ts/cosmos.staking.v1beta1/types"
import { Description } from "thesixnetwork-six-protocol-client-ts/cosmos.staking.v1beta1/types"
import { Validator } from "thesixnetwork-six-protocol-client-ts/cosmos.staking.v1beta1/types"
import { ValAddresses } from "thesixnetwork-six-protocol-client-ts/cosmos.staking.v1beta1/types"
import { DVPair } from "thesixnetwork-six-protocol-client-ts/cosmos.staking.v1beta1/types"
import { DVPairs } from "thesixnetwork-six-protocol-client-ts/cosmos.staking.v1beta1/types"
import { DVVTriplet } from "thesixnetwork-six-protocol-client-ts/cosmos.staking.v1beta1/types"
import { DVVTriplets } from "thesixnetwork-six-protocol-client-ts/cosmos.staking.v1beta1/types"
import { Delegation } from "thesixnetwork-six-protocol-client-ts/cosmos.staking.v1beta1/types"
import { UnbondingDelegation } from "thesixnetwork-six-protocol-client-ts/cosmos.staking.v1beta1/types"
import { UnbondingDelegationEntry } from "thesixnetwork-six-protocol-client-ts/cosmos.staking.v1beta1/types"
import { RedelegationEntry } from "thesixnetwork-six-protocol-client-ts/cosmos.staking.v1beta1/types"
import { Redelegation } from "thesixnetwork-six-protocol-client-ts/cosmos.staking.v1beta1/types"
import { Params } from "thesixnetwork-six-protocol-client-ts/cosmos.staking.v1beta1/types"
import { DelegationResponse } from "thesixnetwork-six-protocol-client-ts/cosmos.staking.v1beta1/types"
import { RedelegationEntryResponse } from "thesixnetwork-six-protocol-client-ts/cosmos.staking.v1beta1/types"
import { RedelegationResponse } from "thesixnetwork-six-protocol-client-ts/cosmos.staking.v1beta1/types"
import { Pool } from "thesixnetwork-six-protocol-client-ts/cosmos.staking.v1beta1/types"
import { ValidatorApproval } from "thesixnetwork-six-protocol-client-ts/cosmos.staking.v1beta1/types"
	...
	actions: {
		...
		async QueryValidatorApproval({ commit, rootGetters, getters }, { options: { subscribe, all} = { subscribe:false, all:false}, params, query=null }) {
			try {
				...
				let value= (await client.CosmosStakingV1Beta1.query.queryValidatorApproval()).data
		...
		async sendMsgSetValidatorApproval({ rootGetters }, { value, fee = [], memo = '' }) {
			try {
				const client=await initClient(rootGetters)
				const result = await client.CosmosStakingV1Beta1.tx.sendMsgSetValidatorApproval({ value, fee: {amount: fee, gas: "200000"}, memo })
				return result
			} catch (e) {
				if (e == MissingWalletError) {
		...
		async MsgSetValidatorApproval({ rootGetters }, { value }) {
			try {
				const client=initClient(rootGetters)
				const msg = await client.CosmosStakingV1Beta1.tx.msgSetValidatorApproval({value})
				return msg
			} catch (e) {
				if (e == MissingWalletError) {
					throw new Error('TxClient:MsgSetValidatorApproval:Init Could not initialize signing client. Wallet is required.')
