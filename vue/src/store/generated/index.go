...
import EvmosEthermintEthermintEvmV1 from './evmos/ethermint/ethermint.evm.v1'
import EvmosEthermintEthermintFeemarketV1 from './evmos/ethermint/ethermint.feemarket.v1'
import EvmosEthermintEthermintFeemarketV2 from './evmos/ethermint/ethermint.feemarket.v2'
...
import ThesixnetworkSixProtocolThesixnetworkSixprotocolNftadmin from './thesixnetwork/six-protocol/thesixnetwork.sixprotocol.nftadmin'
import ThesixnetworkSixProtocolThesixnetworkSixprotocolNftmngr from './thesixnetwork/six-protocol/thesixnetwork.sixprotocol.nftmngr'
import ThesixnetworkSixProtocolThesixnetworkSixprotocolNftoracle from './thesixnetwork/six-protocol/thesixnetwork.sixprotocol.nftoracle'
...
export default { 
  ...
  EvmosEthermintEthermintEvmV1: load(EvmosEthermintEthermintEvmV1, 'ethermint.evm.v1'),
  EvmosEthermintEthermintFeemarketV1: load(EvmosEthermintEthermintFeemarketV1, 'ethermint.feemarket.v1'),
  EvmosEthermintEthermintFeemarketV2: load(EvmosEthermintEthermintFeemarketV2, 'ethermint.feemarket.v2'),
  ...
  ThesixnetworkSixProtocolThesixnetworkSixprotocolNftadmin: load(ThesixnetworkSixProtocolThesixnetworkSixprotocolNftadmin, 'thesixnetwork.sixprotocol.nftadmin'),
  ThesixnetworkSixProtocolThesixnetworkSixprotocolNftmngr: load(ThesixnetworkSixProtocolThesixnetworkSixprotocolNftmngr, 'thesixnetwork.sixprotocol.nftmngr'),
  ThesixnetworkSixProtocolThesixnetworkSixprotocolNftoracle: load(ThesixnetworkSixProtocolThesixnetworkSixprotocolNftoracle, 'thesixnetwork.sixprotocol.nftoracle'),
