...
export type V1MsgBatchSendToEthClaimResponse = object;
...
export interface V1QueryAttestationsResponse {
...
export interface V1QueryPendingIbcAutoForwardsResponse {
...
/**
 * @title gravity/v1/attestation.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  msgBatchSendToEthClaim = (
    ...
    this.request<V1MsgBatchSendToEthClaimResponse, RpcStatus>({
  ...
  msgExecuteIbcAutoForwards = (query?: { forwards_to_clear?: string; executor?: string }, params: RequestParams = {}) =>
    this.request<V1MsgExecuteIbcAutoForwardsResponse, RpcStatus>({
  ...
  msgSendToCosmosClaim = (
    ...
    this.request<V1MsgSendToCosmosClaimResponse, RpcStatus>({
  ...
  msgSubmitBadSignatureEvidence = (
    ...
    this.request<V1MsgSubmitBadSignatureEvidenceResponse, RpcStatus>({
  ...
  queryGetAttestations = (
    ...
    this.request<V1QueryAttestationsResponse, RpcStatus>({
  ...
  queryGetPendingIbcAutoForwards = (query?: { limit?: string }, params: RequestParams = {}) =>
    this.request<V1QueryPendingIbcAutoForwardsResponse, RpcStatus>({
