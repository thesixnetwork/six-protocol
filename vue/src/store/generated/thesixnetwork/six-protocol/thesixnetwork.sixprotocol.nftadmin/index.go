...
import { Permission } from "./module/types/nftadmin/permissions"
import { Permissions } from "./module/types/nftadmin/permissions"


export { Authorization, Params, AddressList, Permission, Permissions };
...
export default {
	...
	actions: {
		init({ dispatch, rootGetters }) {
			console.log('Vuex module: thesixnetwork.sixprotocol.nftadmin initialized!')
