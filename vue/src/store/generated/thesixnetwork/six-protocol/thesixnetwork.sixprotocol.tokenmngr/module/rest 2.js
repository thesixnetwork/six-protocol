...
export class Api extends HttpClient {
    constructor() {
         ...
         */
        this.queryMintpermAll = (query, params = {}) => this.request({
         ...
         */
        this.queryMintperm = (token, address, params = {}) => this.request({
         ...
         */
        this.queryOptions = (params = {}) => this.request({
         ...
         */
        this.queryToken = (name, params = {}) => this.request({
