...
import (
	...
	"github.com/thesixnetwork/six-protocol/x/gravity/client/cli"
	"github.com/thesixnetwork/six-protocol/x/gravity/client/rest"
...
func (am AppModule) RegisterServices(cfg module.Configurator) {
	...
	if err := cfg.RegisterMigration(types.ModuleName, 1, m.NoOpStoreMigrate); err != nil {
