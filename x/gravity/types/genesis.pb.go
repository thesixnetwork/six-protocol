...
func (*GravityNonces) Descriptor() ([]byte, []int) {
	return fileDescriptor_208026f34526cdde, []int{2}
}
...
func init() {
	proto.RegisterType((*Params)(nil), "gravity.Params")
	proto.RegisterType((*GenesisState)(nil), "gravity.GenesisState")
	proto.RegisterType((*GravityNonces)(nil), "gravity.GravityNonces")
}
...
var fileDescriptor_208026f34526cdde = []byte{
	...
	,
}
