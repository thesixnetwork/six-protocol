...
func (m *ActiveVirtualSchemaProposal) GetRegistry() []*VirtualSchemaRegistry {
	if m != nil {
		return m.Registry
	}
	return nil
...
var fileDescriptor_77da69296ca3a224 = []byte{
	...
	0xe8, 0x41, 0xcd, 0x91, 0x92, 0x81, 0x19, 0x88, 0x6a, 0x12, 0xc4, 0x00, 0xa5, 0x8d, 0x8c, 0x5c,
	0xd2, 0x8e, 0x60, 0x9b, 0xc2, 0x20, 0xd2, 0xc1, 0x60, 0xd9, 0x00, 0xa8, 0x35, 0x42, 0x7c, 0x5c,
	0x4c, 0x99, 0x29, 0x12, 0x8c, 0x0a, 0x8c, 0x1a, 0x9c, 0x41, 0x4c, 0x99, 0x29, 0x42, 0x3a, 0x5c,
	0x82, 0x65, 0xc8, 0x0a, 0x9d, 0xf3, 0x53, 0x52, 0x25, 0x98, 0xc0, 0xd2, 0x98, 0x12, 0x42, 0x21,
	0x5c, 0x1c, 0x45, 0xa9, 0xe9, 0x99, 0xc5, 0x25, 0x45, 0x95, 0x12, 0xcc, 0x0a, 0xcc, 0x1a, 0xdc,
	0x46, 0x16, 0x7a, 0x04, 0x5d, 0xac, 0x87, 0xe2, 0x92, 0x20, 0xa8, 0xfe, 0x20, 0xb8, 0x49, 0x4e,
	...
	0x51, 0x9a, 0xa4, 0x97, 0x9c, 0x9f, 0xab, 0x8f, 0x62, 0x8f, 0x7e, 0x71, 0x66, 0x85, 0x2e, 0xcc,
	0x22, 0xfd, 0x0a, 0x7d, 0x58, 0x98, 0x94, 0x54, 0x16, 0xa4, 0x16, 0x27, 0xb1, 0x81, 0x65, 0x8c,
	0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0x67, 0xd0, 0x5e, 0x06, 0x7c, 0x01, 0x00, 0x00,
}
...
func (m *ActiveVirtualSchemaProposal) MarshalToSizedBuffer(dAtA []byte) (int, error) {
		...
		for iNdEx := len(m.Registry) - 1; iNdEx >= 0; iNdEx-- {
			{
				...
				i -= size
				i = encodeVarintActiveVirtualSchemaProposal(dAtA, i, uint64(size))
			}
			i--
			dAtA[i] = 0x1a
		}
	...
	if len(m.Id) > 0 {
		i -= len(m.Id)
		copy(dAtA[i:], m.Id)
		i = encodeVarintActiveVirtualSchemaProposal(dAtA, i, uint64(len(m.Id)))
		i--
		dAtA[i] = 0xa
	}
