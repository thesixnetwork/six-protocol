...
var (
	...
	pattern_Query_DisableVirtualSchema_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"thesixnetwork", "sixnft", "nftmngr", "disable_virtual_schema", "index"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_DisableVirtualSchemaAll_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"thesixnetwork", "sixnft", "nftmngr", "disable_virtual_schema"}, "", runtime.AssumeColonVerbOpt(true)))
