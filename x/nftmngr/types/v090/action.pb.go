...
type Action struct {
	...
	AllowedActioner AllowedActioner `protobuf:"varint,6,opt,name=allowed_actioner,json=allowedActioner,proto3,enum=thesixnetwork.sixprotocol.nftmngr.v090.AllowedActioner" json:"allowed_actioner,omitempty"`
...
func init() {
	proto.RegisterEnum("thesixnetwork.sixprotocol.nftmngr.v090.AllowedActioner", AllowedActioner_name, AllowedActioner_value)
	proto.RegisterType((*ActionParams)(nil), "thesixnetwork.sixprotocol.nftmngr.v090.action_params")
	proto.RegisterType((*Action)(nil), "thesixnetwork.sixprotocol.nftmngr.v090.Action")
}
...
var fileDescriptor_531a14b8607bc409 = []byte{
	...
	0x85, 0x44, 0x32, 0x0d, 0x21, 0x04, 0xb7, 0x0c, 0x7a, 0x40, 0x0a, 0xab, 0x94, 0x06, 0xd0, 0xb8,
	...
	0xda, 0x2f, 0xff, 0x05, 0x00, 0x00, 0xff, 0xff, 0x71, 0x31, 0x66, 0x87, 0xf2, 0x02, 0x00, 0x00,
}
