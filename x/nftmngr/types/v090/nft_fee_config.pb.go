...
// source: nftmngr/v090/nft_fee_config.proto
...
func (FeeDistributionMethod) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_f522059561b01f33, []int{0}
}

type FeeDistribution struct {
	Method  FeeDistributionMethod `protobuf:"varint,1,opt,name=method,proto3,enum=thesixnetwork.sixprotocol.nftmngr.v090.FeeDistributionMethod" json:"method,omitempty"`
...
func (*FeeConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_f522059561b01f33, []int{1}
}
...
func (*NFTFeeConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_f522059561b01f33, []int{2}
}
...
func init() {
	proto.RegisterEnum("thesixnetwork.sixprotocol.nftmngr.v090.FeeDistributionMethod", FeeDistributionMethod_name, FeeDistributionMethod_value)
	proto.RegisterType((*FeeDistribution)(nil), "thesixnetwork.sixprotocol.nftmngr.v090.FeeDistribution")
	proto.RegisterType((*FeeConfig)(nil), "thesixnetwork.sixprotocol.nftmngr.v090.FeeConfig")
	proto.RegisterType((*NFTFeeConfig)(nil), "thesixnetwork.sixprotocol.nftmngr.v090.NFTFeeConfig")
}

func init() { proto.RegisterFile("nftmngr/v090/nft_fee_config.proto", fileDescriptor_f522059561b01f33) }

var fileDescriptor_f522059561b01f33 = []byte{
	...
	0x88, 0x89, 0x2d, 0xe2, 0xc2, 0x68, 0x62, 0x22, 0x08, 0x5d, 0x29, 0x90, 0x11, 0x62, 0xe2, 0x06,
	...
	0x29, 0x19, 0x1f, 0xbc, 0x05, 0x00, 0x00, 0xff, 0xff, 0x4c, 0xb5, 0x55, 0x45, 0x65, 0x02, 0x00,
	0x00,
}
