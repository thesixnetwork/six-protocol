...
// source: nftmngr/v091/action_by_ref_id.proto
...
func (*ActionByRefId) Descriptor() ([]byte, []int) {
	return fileDescriptor_5b201b1de9855fcb, []int{0}
}
...
func init() {
	proto.RegisterType((*ActionByRefId)(nil), "thesixnetwork.sixprotocol.nftmngr.v091.ActionByRefId")
}

func init() {
	proto.RegisterFile("nftmngr/v091/action_by_ref_id.proto", fileDescriptor_5b201b1de9855fcb)
}

var fileDescriptor_5b201b1de9855fcb = []byte{
	...
	0x69, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x2a, 0x39, 0xff, 0x32, 0x45, 0x01, 0x00, 0x00,
}
