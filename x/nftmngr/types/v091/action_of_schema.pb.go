...
// source: nftmngr/v091/action_of_schema.proto
...
func (*ActionOfSchema) Descriptor() ([]byte, []int) {
	return fileDescriptor_d23be301e76ac7c4, []int{0}
}
...
func init() {
	proto.RegisterType((*ActionOfSchema)(nil), "thesixnetwork.sixprotocol.nftmngr.v091.ActionOfSchema")
}

func init() {
	proto.RegisterFile("nftmngr/v091/action_of_schema.proto", fileDescriptor_d23be301e76ac7c4)
}

var fileDescriptor_d23be301e76ac7c4 = []byte{
	...
	0xd2, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x6c, 0xc2, 0xe0, 0x30, 0x0d, 0x01, 0x00, 0x00,
}
