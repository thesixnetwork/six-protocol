...
// source: nftmngr/v092/action_executor.proto
...
func (*ActionExecutor) Descriptor() ([]byte, []int) {
	return fileDescriptor_6c96deb21f8aeb24, []int{0}
}
...
func (*ActionExecutorBySchema) Descriptor() ([]byte, []int) {
	return fileDescriptor_6c96deb21f8aeb24, []int{1}
}
...
func init() {
	proto.RegisterType((*ActionExecutor)(nil), "thesixnetwork.sixprotocol.nftmngr.v092.ActionExecutor")
	proto.RegisterType((*ActionExecutorBySchema)(nil), "thesixnetwork.sixprotocol.nftmngr.v092.ActionExecutorBySchema")
}

func init() {
	proto.RegisterFile("nftmngr/v092/action_executor.proto", fileDescriptor_6c96deb21f8aeb24)
}

var fileDescriptor_6c96deb21f8aeb24 = []byte{
	...
	0x5a, 0x0c, 0x0e, 0xf9, 0x24, 0x36, 0xb0, 0xb4, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0x3c, 0x91,
	0x98, 0xee, 0x90, 0x01, 0x00, 0x00,
}
