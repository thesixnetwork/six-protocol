...
// source: nftmngr/v092/action_of_schema.proto
...
func (*ActionOfSchema) Descriptor() ([]byte, []int) {
	return fileDescriptor_95a6c4c8630ed7e5, []int{0}
}
...
func init() {
	proto.RegisterType((*ActionOfSchema)(nil), "thesixnetwork.sixprotocol.nftmngr.v092.ActionOfSchema")
}

func init() {
	proto.RegisterFile("nftmngr/v092/action_of_schema.proto", fileDescriptor_95a6c4c8630ed7e5)
}

var fileDescriptor_95a6c4c8630ed7e5 = []byte{
	...
	0xd2, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xb9, 0x0d, 0x13, 0xf4, 0x0d, 0x01, 0x00, 0x00,
}
