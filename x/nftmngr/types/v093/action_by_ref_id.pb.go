...
// source: nftmngr/v093/action_by_ref_id.proto
...
func (*ActionByRefId) Descriptor() ([]byte, []int) {
	return fileDescriptor_c87b2b7af58fb606, []int{0}
}
...
func init() {
	proto.RegisterType((*ActionByRefId)(nil), "thesixnetwork.sixprotocol.nftmngr.v093.ActionByRefId")
}

func init() {
	proto.RegisterFile("nftmngr/v093/action_by_ref_id.proto", fileDescriptor_c87b2b7af58fb606)
}

var fileDescriptor_c87b2b7af58fb606 = []byte{
	...
	0x69, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0xb3, 0xc4, 0x3c, 0x15, 0x45, 0x01, 0x00, 0x00,
}
