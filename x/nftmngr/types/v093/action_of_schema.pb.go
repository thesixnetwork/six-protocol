...
// source: nftmngr/v093/action_of_schema.proto
...
func (*ActionOfSchema) Descriptor() ([]byte, []int) {
	return fileDescriptor_096ba3b21b4c4823, []int{0}
}
...
func init() {
	proto.RegisterType((*ActionOfSchema)(nil), "thesixnetwork.sixprotocol.nftmngr.v093.ActionOfSchema")
}

func init() {
	proto.RegisterFile("nftmngr/v093/action_of_schema.proto", fileDescriptor_096ba3b21b4c4823)
}

var fileDescriptor_096ba3b21b4c4823 = []byte{
	...
	0xd2, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x0a, 0xb7, 0xbd, 0xb7, 0x0d, 0x01, 0x00, 0x00,
}
