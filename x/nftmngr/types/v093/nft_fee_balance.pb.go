...
// source: nftmngr/v093/nft_fee_balance.proto
...
func (*NFTFeeBalance) Descriptor() ([]byte, []int) {
	return fileDescriptor_ce45c67cfe58e115, []int{0}
}
...
func init() {
	proto.RegisterType((*NFTFeeBalance)(nil), "thesixnetwork.sixprotocol.nftmngr.v093.NFTFeeBalance")
}

func init() {
	proto.RegisterFile("nftmngr/v093/nft_fee_balance.proto", fileDescriptor_ce45c67cfe58e115)
}

var fileDescriptor_ce45c67cfe58e115 = []byte{
	...
	0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xb3, 0xf7, 0x71, 0x88, 0xde, 0x00, 0x00, 0x00,
}
