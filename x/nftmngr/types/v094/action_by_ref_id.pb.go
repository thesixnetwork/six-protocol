...
// source: nftmngr/v094/action_by_ref_id.proto
...
func (*ActionByRefId) Descriptor() ([]byte, []int) {
	return fileDescriptor_6003bb48160043b6, []int{0}
}
...
func init() {
	proto.RegisterType((*ActionByRefId)(nil), "thesixnetwork.sixprotocol.nftmngr.v094.ActionByRefId")
}

func init() {
	proto.RegisterFile("nftmngr/v094/action_by_ref_id.proto", fileDescriptor_6003bb48160043b6)
}

var fileDescriptor_6003bb48160043b6 = []byte{
	...
	0x69, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0xf4, 0xbf, 0x21, 0x83, 0x45, 0x01, 0x00, 0x00,
}
