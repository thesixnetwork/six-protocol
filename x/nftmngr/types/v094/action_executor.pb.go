...
// source: nftmngr/v094/action_executor.proto
...
func (*ActionExecutor) Descriptor() ([]byte, []int) {
	return fileDescriptor_071df82631d0c666, []int{0}
}
...
func (*ActionExecutorBySchema) Descriptor() ([]byte, []int) {
	return fileDescriptor_071df82631d0c666, []int{1}
}
...
func init() {
	proto.RegisterType((*ActionExecutor)(nil), "thesixnetwork.sixprotocol.nftmngr.v094.ActionExecutor")
	proto.RegisterType((*ActionExecutorBySchema)(nil), "thesixnetwork.sixprotocol.nftmngr.v094.ActionExecutorBySchema")
}

func init() {
	proto.RegisterFile("nftmngr/v094/action_executor.proto", fileDescriptor_071df82631d0c666)
}

var fileDescriptor_071df82631d0c666 = []byte{
	...
	0x5a, 0x0c, 0x0e, 0xf9, 0x24, 0x36, 0xb0, 0xb4, 0x31, 0x20, 0x00, 0x00, 0xff, 0xff, 0xab, 0xe6,
	0x5c, 0xf3, 0x90, 0x01, 0x00, 0x00,
}
