...
type VirtualSchemaProposalRequest struct {
	NftSchemaCodes []string  `protobuf:"bytes,1,rep,name=nftSchemaCodes,proto3" json:"nftSchemaCodes,omitempty"`
...
func (m *VirtualSchemaProposalRequest) GetNftSchemaCodes() []string {
	if m != nil {
		return m.NftSchemaCodes
	}
	return nil
}
...
var fileDescriptor_1fd45310b3f69052 = []byte{
	...
	,
}
...
func (m *VirtualSchemaProposalRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.NftSchemaCodes) > 0 {
		for iNdEx := len(m.NftSchemaCodes) - 1; iNdEx >= 0; iNdEx-- {
			i -= len(m.NftSchemaCodes[iNdEx])
			copy(dAtA[i:], m.NftSchemaCodes[iNdEx])
			i = encodeVarintVirtualSchema(dAtA, i, uint64(len(m.NftSchemaCodes[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *VirtualSchemaProposalRequest) Size() (n int) {
	...
	_ = l
	if len(m.NftSchemaCodes) > 0 {
		for _, s := range m.NftSchemaCodes {
			l = len(s)
			n += 1 + l + sovVirtualSchema(uint64(l))
		}
	}
...
func (m *VirtualSchemaProposalRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field NftSchemaCodes", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.NftSchemaCodes = append(m.NftSchemaCodes, string(dAtA[iNdEx:postIndex]))
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Actions", wireType)
