...
// coins in the reserve equals the total fractional balances + remainder.
...
// and the remainder is divisible by the conversion factor.
...
// fractional denoms (asix should only exist in x/precisebank).
