...
func TestTokenBurnQuerySingle(t *testing.T) {
	...
	tests := []struct {
		...
		{
			desc:     "First",
			request:  &types.QueryGetTokenBurnRequest{Index: msgs[0].Amount.Denom},
			response: &types.QueryGetTokenBurnResponse{TokenBurn: msgs[0]},
		},
		{
			desc:     "Second",
			request:  &types.QueryGetTokenBurnRequest{Index: msgs[1].Amount.Denom},
			response: &types.QueryGetTokenBurnResponse{TokenBurn: msgs[1]},
		},
		{
			desc:    "KeyNotFound",
			request: &types.QueryGetTokenBurnRequest{Index: "missing"},
